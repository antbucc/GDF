...
/*package*/ class IstanzaGioco_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_11() {
    ...
    editorCell.setCellId("Constant_7h2jo8_u0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new IstanzaGioco_EditorBuilder_a.partecipantiListHandler_7h2jo8_w0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_partecipanti");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class partecipantiListHandler_7h2jo8_w0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public partecipantiListHandler_7h2jo8_w0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return MetaAdapterFactory.getContainmentLink(0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x23eac9cba952c550L, 0xa4e84c9874d0718L, "partecipanti");
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(partecipantiListHandler_7h2jo8_w0.this.getNode(), MetaAdapterFactory.getContainmentLink(0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x23eac9cba952c550L, 0xa4e84c9874d0718L, "partecipanti")));
      try {
