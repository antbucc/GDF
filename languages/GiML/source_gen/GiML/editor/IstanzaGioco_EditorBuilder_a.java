...
/*package*/ class IstanzaGioco_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_1() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new IstanzaGioco_EditorBuilder_a.Inline_Builder1(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, MetaAdapterFactory.getReferenceLink(0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x23eac9cba952c550L, 0x29c2332daaea3e3fL, "scuola"));
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
  ...
  /*package*/ static class Inline_Builder1 extends AbstractEditorBuilder {
    ...
    private EditorCell createCollection_1() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
      editorCell.setCellId("Collection_7h2jo8_a0i0");
    ...
    private EditorCell createRefCell_2() {
      ...
      SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
        protected EditorCell createReferenceCell(final SNode targetNode) {
          EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
            public EditorCell compute() {
              return new IstanzaGioco_EditorBuilder_a.Inline_Builder1.Inline_Builder2(getEditorContext(), getNode(), targetNode).createCell();
            }
    ...
    /*package*/ static class Inline_Builder2 extends AbstractEditorBuilder {
      ...
      private EditorCell createCollection_2() {
        EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
        editorCell.setCellId("Collection_7h2jo8_a0a0a8a");
      ...
      private EditorCell createRefCell_3() {
        ...
        SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
          protected EditorCell createReferenceCell(final SNode targetNode) {
            EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
              public EditorCell compute() {
                return new IstanzaGioco_EditorBuilder_a.Inline_Builder1.Inline_Builder2.Inline_Builder3(getEditorContext(), getNode(), targetNode).createCell();
              }
  ...
  private EditorCell createRefCell_4() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
          public EditorCell compute() {
            return new IstanzaGioco_EditorBuilder_a.Inline_Builder4(getEditorContext(), getNode(), targetNode).createCell();
          }
        }, targetNode, MetaAdapterFactory.getReferenceLink(0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x23eac9cba952c550L, 0x29c2332daaea3e3fL, "scuola"));
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
  ...
  /*package*/ static class Inline_Builder4 extends AbstractEditorBuilder {
    ...
    private EditorCell createCollection_3() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
      editorCell.setCellId("Collection_7h2jo8_a0k0");
    ...
    private EditorCell createRefCell_5() {
      ...
      SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
        protected EditorCell createReferenceCell(final SNode targetNode) {
          EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
            public EditorCell compute() {
              return new IstanzaGioco_EditorBuilder_a.Inline_Builder4.Inline_Builder5(getEditorContext(), getNode(), targetNode).createCell();
            }
          }, targetNode, MetaAdapterFactory.getReferenceLink(0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x29c2332daa804ab6L, 0x29c2332daaaaee97L, "istituto"));
          CellUtil.setupIDeprecatableStyles(targetNode, cell);
          setSemanticNodeToCells(cell, getNode());
  ...
  private EditorCell createConstant_6() {
    ...
    editorCell.setCellId("Constant_7h2jo8_l0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_9() {
    ...
    editorCell.setCellId("Constant_7h2jo8_r0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    style.set(StyleAttributes.TEXT_BACKGROUND_COLOR, StyleRegistry.getInstance().getSimpleColor(MPSColors.DARK_GREEN));
    style.set(StyleAttributes.TEXT_COLOR, StyleRegistry.getInstance().getSimpleColor(MPSColors.WHITE, StyleRegistry.getInstance().getSimpleColor(MPSColors.DARK_GREEN)));
  ...
  private EditorCell createCollection_4() {
    ...
    editorCell.setCellId("Collection_7h2jo8_t0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new IstanzaGioco_EditorBuilder_a.partecipantiListHandler_7h2jo8_a91a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_partecipanti");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class partecipantiListHandler_7h2jo8_a91a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public partecipantiListHandler_7h2jo8_a91a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return MetaAdapterFactory.getContainmentLink(0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x23eac9cba952c550L, 0x29c2332daaf18015L, "partecipanti");
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(partecipantiListHandler_7h2jo8_a91a.this.getNode(), MetaAdapterFactory.getContainmentLink(0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x23eac9cba952c550L, 0x29c2332daaf18015L, "partecipanti")));
      try {
    ...
    private EditorCell createRefCell_6() {
      ...
      SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
        protected EditorCell createReferenceCell(final SNode targetNode) {
          EditorCell cell = getUpdateSession().updateReferencedNodeCell(new Computable<EditorCell>() {
            public EditorCell compute() {
              return new IstanzaGioco_EditorBuilder_a.partecipantiListHandler_7h2jo8_a91a.Inline_Builder6(getEditorContext(), getNode(), targetNode).createCell();
            }
          }, targetNode, MetaAdapterFactory.getReferenceLink(0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x23eac9cba952c550L, 0x29c2332daaea3e3fL, "scuola"));
          CellUtil.setupIDeprecatableStyles(targetNode, cell);
          setSemanticNodeToCells(cell, getNode());
    ...
    /*package*/ static class Inline_Builder6 extends AbstractEditorBuilder {
      ...
      private EditorCell createCollection_5() {
        EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
        editorCell.setCellId("Collection_7h2jo8_a0a0t0");
        editorCell.addEditorCell(createRefNodeList_1());
        return editorCell;
      }
      private EditorCell createRefNodeList_1() {
        AbstractCellListHandler handler = new IstanzaGioco_EditorBuilder_a.partecipantiListHandler_7h2jo8_a91a.Inline_Builder6.classiListHandler_7h2jo8_a0a0a91a(myNode, getEditorContext());
        EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
        editorCell.setCellId("refNodeList_classi");
        editorCell.setSRole(handler.getElementSRole());
        return editorCell;
      }
      private static class classiListHandler_7h2jo8_a0a0a91a extends RefNodeListHandler {
        @NotNull
        private SNode myNode;

        public classiListHandler_7h2jo8_a0a0a91a(SNode ownerNode, EditorContext context) {
          super(context, false);
          myNode = ownerNode;
        }
        ...
        public EditorCell createEmptyCell() {
          getCellFactory().pushCellContext();
          getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(classiListHandler_7h2jo8_a0a0a91a.this.getNode(), MetaAdapterFactory.getContainmentLink(0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x29c2332daa804ab6L, 0x29c2332daacc1750L, "classi")));
          try {
            EditorCell emptyCell = null;
