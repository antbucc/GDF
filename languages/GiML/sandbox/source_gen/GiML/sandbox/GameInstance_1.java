...
public class GameInstance_1 {
  private static final Logger LOG = LogManager.getLogger(GameInstance_1.class);
  ...
  public static void run() throws IOException {
    ...
    LoggingRuntime.logMsgView(Level.INFO, "Result: " + response.body().string(), GameInstance_1.class, null, null);
