...
public class GameInstance_4 {
  private static final Logger LOG = LogManager.getLogger(GameInstance_4.class);
  ...
  public static void run() throws IOException {
    ...
    LoggingRuntime.logMsgView(Level.INFO, "Result: " + response.body().string(), GameInstance_4.class, null, null);
