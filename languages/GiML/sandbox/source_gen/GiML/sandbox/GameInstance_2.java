...
public class GameInstance_2 {
  private static final Logger LOG = LogManager.getLogger(GameInstance_2.class);
  ...
  public static void run() throws IOException {
    ...
    LoggingRuntime.logMsgView(Level.INFO, "Result: " + response.body().string(), GameInstance_2.class, null, null);
