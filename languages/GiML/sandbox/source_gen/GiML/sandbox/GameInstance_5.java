...
public class GameInstance_5 {
  private static final Logger LOG = LogManager.getLogger(GameInstance_5.class);
  ...
  public static void run() throws IOException {
    ...
    LoggingRuntime.logMsgView(Level.INFO, "Result: " + response.body().string(), GameInstance_5.class, null, null);
