...
public class GameInstance_6 {
  private static final Logger LOG = LogManager.getLogger(GameInstance_6.class);
  ...
  public static void run() throws IOException {
    ...
    LoggingRuntime.logMsgView(Level.INFO, "Result: " + response.body().string(), GameInstance_6.class, null, null);
