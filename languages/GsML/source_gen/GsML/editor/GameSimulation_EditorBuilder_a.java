...
/*package*/ class GameSimulation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = MetaAdapterFactory.getReferenceLink(0x26aa16acedaa4cf5L, 0xa912305a69f850f0L, 0x19b939282f55acbcL, 0x19b939282ec33ed2L, "gameInstance");
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, MetaAdapterFactory.getReferenceLink(0x26aa16acedaa4cf5L, 0xa912305a69f850f0L, 0x19b939282f55acbcL, 0x19b939282ec33ed2L, "gameInstance"));
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(MetaAdapterFactory.getReferenceLink(0x26aa16acedaa4cf5L, 0xa912305a69f850f0L, 0x19b939282f55acbcL, 0x19b939282ec33ed2L, "gameInstance"));
    }
  ...
  private static class listOfExecutionsListHandler_rmrqsp_c5a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return MetaAdapterFactory.getContainmentLink(0x26aa16acedaa4cf5L, 0xa912305a69f850f0L, 0x19b939282f55acbcL, 0x19b939282f55acd3L, "listOfExecutions");
    }
    public SAbstractConcept getChildSConcept() {
      return MetaAdapterFactory.getConcept(0x26aa16acedaa4cf5L, 0xa912305a69f850f0L, 0x19b939282f55acd6L, "GsML.structure.SingleGameExecution");
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(listOfExecutionsListHandler_rmrqsp_c5a.this.getNode(), MetaAdapterFactory.getContainmentLink(0x26aa16acedaa4cf5L, 0xa912305a69f850f0L, 0x19b939282f55acbcL, 0x19b939282f55acd3L, "listOfExecutions")));
      try {
