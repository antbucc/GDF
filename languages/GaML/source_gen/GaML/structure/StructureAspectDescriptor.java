...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptExperienceLevel = createDescriptorForExperienceLevel();
  ...
  /*package*/ final ConceptDescriptor myConceptKGGBadge = createDescriptorForKGGBadge();
  ...
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptClassroom, myConceptComplexTeam, myConceptDashboard, myConceptDomain, myConceptExperienceLevel, myConceptGameDefinition, myConceptInstitute, myConceptKGGBadge, myConceptKGGBadgeCollection, myConceptSchool, myConceptSinglePlayerChallenge, myConceptStudent, myConceptVolontario, myConceptdataDrivenAction, myConcepteventDrivenAction, myConceptexperiencePoint, myConceptskillPoint);
  }
  ...
  public ConceptDescriptor getDescriptor(SConceptId id) {
    switch (myIndexSwitch.index(id)) {
      ...
      case LanguageConceptSwitch.ExperienceLevel:
        return myConceptExperienceLevel;
  ...
  private static ConceptDescriptor createDescriptorForKGGBadge() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("GaML", "KGGBadge", 0x1472546da96448a0L, 0xa11e4271b165a42cL, 0x60acec85f6307751L);
    b.class_(false, false, true);
