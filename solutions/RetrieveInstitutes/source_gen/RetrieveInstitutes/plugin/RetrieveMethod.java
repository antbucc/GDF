...
public class RetrieveMethod implements Runnable {
  ...
  private static String Token = "c5fdc0bf-7ccd-4c37-914d-8f87bacb37fb";
  ...
  public void run() {
    ...
    SNode domain = createDomainInstance_7rmalq_a0c0p();
  ...
  private SNode addInstituteNode(Institute institute, SNode domain) {
    ...
    SNode instituteNode = createInstituteInstance_7rmalq_a0b0u(domain, institute.address, institute.name, institute.ownerId, institute.objectId, SPropertyOperations.getString(domain, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + institute.name);
    return instituteNode;
  }

  private SNode addSchoolNode(School school, SNode instituteNode, SNode domain) {
    SNode schoolNode = createSchoolInstance_7rmalq_a0a0w(instituteNode, school.address, school.name, school.objectId, SPropertyOperations.getString(domain, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + SPropertyOperations.getString(instituteNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + school.name);
    return schoolNode;
  }
  private SNode addClassRoomNode(String classroom, School school, SNode instituteNode, SNode domain, SNode schoolInstance) {
    SNode classroomNode = createClassroomInstance_7rmalq_a0a0x(schoolInstance, classroom, SPropertyOperations.getString(domain, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + SPropertyOperations.getString(instituteNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + school.name + "." + classroom);
  ...
  private SNode addStudentNode(Student student, SNode instituteNode, School school, SNode classroomNode, SNode domain) {
    SNode studentNode = createStudentInstance_7rmalq_a0a0z(classroomNode, student.name, student.surname, SPropertyOperations.getString(domain, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + SPropertyOperations.getString(instituteNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + school.name + "." + SPropertyOperations.getString(classroomNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + student);
  ...
  private SNode addGameNode(Game game, SNode instituteNode, SNode schoolNode) throws IOException {
    ...
    for (int i = 0; i < game.classRooms.length; i++) {
      ...
      SNode current1 = createClassroomInstance_7rmalq_a0b0b0db(schoolNode, current);
    ...
    for (int l = 0; l < points.length; l++) {
      ...
      if (current.name.contains("trips") || current.name.contains("distance")) {
        // skills 
        SNode pointNode = createskillPointInstance_7rmalq_a0b0c0j0db(current.name, current.score, SPropertyOperations.getString(instituteNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + SPropertyOperations.getString(schoolNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + "[GameInstance]-" + game.gameName + "." + "Skill Points");
    ...
    for (int h = 0; h < actions.length; h++) {
      ...
      if (current.contains("Filled")) {
        ...
        SNode actionNode = createeventDrivenActionInstance_7rmalq_a0b0c0q0db(current, SPropertyOperations.getString(instituteNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + SPropertyOperations.getString(schoolNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + "[GameInstance]-" + game.gameName + "." + "EventDriven Actions");
    ...
    for (BadgeCollection collection : collections) {
      SNode collectionNode = createBadgeCollectionInstance_7rmalq_a0a0v0db(collection.name, SPropertyOperations.getString(instituteNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + SPropertyOperations.getString(schoolNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + "[GameInstance]-" + game.gameName + "." + "BadgeCollections");
    ...
    for (Challenge challenge : challenges) {
      ...
      SNode challengeNode = createSinglePlayerChallengeInstance_7rmalq_a0d0bb0db(variables, challenge.name, challenge.id, SPropertyOperations.getString(instituteNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + SPropertyOperations.getString(schoolNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + "[GameInstance]-" + game.gameName + "." + "SinglePlayerChallenges");
      challengeNodes.add(challengeNode);
      SModelOperations.addRootNode(this.myModel, challengeNode);

    }

    SNode gameNode = createGameInstance_7rmalq_a0db0db(schoolNode, instituteNode, schoolNode, classInstances, experiencePointInstances, skillPointInstances, dataActions, eventActions, collectionsNodes, challengeNodes, game.gameName, game.gameId, game.gameDescription, game.from, game.to, SPropertyOperations.getString(instituteNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + SPropertyOperations.getString(schoolNode, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name")) + "." + "[GameInstance]-" + game.gameName);
  ...
  private Institute[] doGetInstitutes(String url) throws IOException {
    ...
    LoggingRuntime.logMsgView(Level.INFO, "numero di istituti: " + istituti.length, RetrieveMethod.class, null, null);
  ...
  private School[] doGetSchools(String url, String instituteId) throws IOException {
    ...
    LoggingRuntime.logMsgView(Level.INFO, "numedo di scuole" + schools.length, RetrieveMethod.class, null, null);
    return schools;
  ...
  private static SNode createDomainInstance_7rmalq_a0c0p() {
  ...
  private static SNode createInstituteInstance_7rmalq_a0b0u(SNode node0, Object p0, Object p1, Object p2, Object p3, Object p4) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode createClassroomInstance_7rmalq_a0b0b0db(SNode node0, Object p0) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode n1 = SModelUtil_new.instantiateConceptDeclaration(MetaAdapterFactory.getConcept(0x119e117f12604f12L, 0xb46eefd3d0e4c44fL, 0x29c2332daad26af7L, "GiML.structure.ClassroomInstance"), null, null, false);
    n1.setProperty(MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), p0 + "");
    n1.setReferenceTarget(MetaAdapterFactory.getReferenceLink(0x119e117f12604f12L, 0xb46eefd3d0e4c44fL, 0x29c2332daad26af7L, 0x77937ef710bbc239L, "relatedSchool"), node0);
  ...
  private static SNode createexperiencePointInstance_7rmalq_a0b0b0j0db(Object p0, Object p1, Object p2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode createskillPointInstance_7rmalq_a0b0c0j0db(Object p0, Object p1, Object p2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode createdataDrivenActionInstance_7rmalq_a0a0b0q0db(Object p0, Object p1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode createeventDrivenActionInstance_7rmalq_a0b0c0q0db(Object p0, Object p1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode createBadgeCollectionInstance_7rmalq_a0a0v0db(Object p0, Object p1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode createSinglePlayerChallengeInstance_7rmalq_a0d0bb0db(Iterable<? extends SNode> seq0, Object p0, Object p1, Object p2) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode createGameInstance_7rmalq_a0db0db(SNode node0, SNode node1, SNode node2, Iterable<? extends SNode> seq0, Iterable<? extends SNode> seq1, Iterable<? extends SNode> seq2, Iterable<? extends SNode> seq3, Iterable<? extends SNode> seq4, Iterable<? extends SNode> seq5, Iterable<? extends SNode> seq6, Object p0, Object p1, Object p2, Object p3, Object p4, Object p5) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
