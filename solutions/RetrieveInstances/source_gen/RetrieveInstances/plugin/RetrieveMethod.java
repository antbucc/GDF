...
public class RetrieveMethod implements Runnable {
  ...
  public void run() {
    SNode node = createIstanzaDominio_7rmalq_a0a0b();
    try {
      String result = this.doGetRequest("www.google.it");
  ...
  private String doGetRequest(String url) throws IOException {
    ...
    LoggingRuntime.logMsgView(Level.WARN, url, RetrieveMethod.class, null, null);
  ...
  private static SNode createIstanzaDominio_7rmalq_a0a0b() {
